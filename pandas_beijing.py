...
df.to_csv("csvResult/Beijing_reduced_data.csv")
df_year.to_csv("csvResult/Beijing_year_data.csv")
df_month_pm.to_csv("csvResult/Beijing_month_pm_data.csv")
df_month_temp.to_csv("csvResult/Beijing_month_temp_data.csv")
